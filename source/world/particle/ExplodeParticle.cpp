	...
	Particle(level, pos, dir)
{
	...
	m_rCol = m_gCol = m_bCol = 0.7f + 0.3f * m_random.nextFloat();
	field_F0 = 1.0f + 6.0f * m_random.nextFloat() * m_random.nextFloat();
	field_EC = int(16.0f / (0.2f + 0.8f * m_random.nextFloat())) + 2;
}
