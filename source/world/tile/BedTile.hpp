...
public:
	...
	PushReaction getPistonPushReaction() override;

	static Facing::Name getDirectionFromData(int meta)
	{
		return Facing::Name(meta & 3);
	}
	...
	static void setOccupied(Level* level, const TilePos& pos, bool);
	static TilePos findStandUpPosition(const Level* level, const TilePos& pos, int steps);
