...
void SoundSystemSL::playAt(const SoundDesc &sound, const Vec3& pos, float volume, float pitch, bool isUI)
{
	removeStoppedSounds();
	...
	checkErr((*pBufferQueueItf)->Enqueue(pBufferQueueItf, sound.m_pData, sound.m_size));
